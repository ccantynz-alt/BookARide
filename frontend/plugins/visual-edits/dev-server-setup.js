      ...
      try {
        ...
        Object.entries(changesByFile).forEach(([fileName, fileChanges]) => {
          ...
          try {
            ...
            execSync(`git -c user.name="visual-edit" -c user.email="system@bookaride.co.nz" add "${targetFile}"`);
            execSync(`git -c user.name="visual-edit" -c user.email="system@bookaride.co.nz" commit -m "visual_edit_${timestamp}"`);
          } catch (gitError) {
