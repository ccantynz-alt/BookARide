      ...
      <nav className="container mx-auto px-4 py-4">
        <div className="flex items-center justify-between">
          ...
          <Link to="/" className="flex items-center space-x-2 group">
            ...
            <span className="text-2xl font-bold text-gray-900">BookaRide</span>
          </Link>
          ...
          <div className="hidden md:flex items-center space-x-4">
            <a href="tel:+6491234567" className="flex items-center space-x-2 text-gray-700 hover:text-amber-600 transition-colors duration-200">
          ...
          <div className="md:hidden mt-4 pb-4 space-y-4 border-t border-gray-200 pt-4">
            {navLinks.map((link) => (
              <Link
                ...
                className={`block text-sm font-medium transition-colors duration-200 hover:text-amber-600 ${
                  isActive(link.path) ? 'text-amber-600' : 'text-gray-700'
                }`}
              >
                {link.label}
