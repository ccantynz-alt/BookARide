...
const GreyLynnAirportPage = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
      <SEO
        title="Grey Lynn to Auckland Airport Shuttle | Private Transfer | BookaRide"
        description="Book your Grey Lynn to Auckland Airport private transfer. Door-to-door from Great North Road, Richmond Road, Grey Lynn Park. Get instant quote!"
        keywords="Grey Lynn airport transfer, Grey Lynn to Auckland Airport, Grey Lynn shuttle, Great North Road airport taxi"
        canonical="/grey-lynn-to-airport"
      />
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6">
              Grey Lynn to <span className="text-gold">Auckland Airport</span>
            </h1>
            
            <p className="text-xl text-gray-300 mb-4">
              Private transfers from Auckland's creative inner-west
            </p>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold mb-8 text-center">Grey Lynn Airport Transfer Service</h2>
            <div className="prose prose-lg max-w-none">
              <p>
                Grey Lynn is one of Auckland's most sought-after inner suburbs, known for its creative community, 
                beautiful villa-lined streets, and the popular Grey Lynn Park with its annual festival. The area 
                attracts young professionals and families who appreciate its village atmosphere.
              </p>
              <p>
                BookaRide offers convenient airport transfers from anywhere in Grey Lynn. Whether you're near 
                Great North Road, the park, or closer to Ponsonby, we'll pick you up from your door and get 
                you to Auckland Airport stress-free.
              </p>
            </div>

            <div className="mt-12">
              <h3 className="text-xl font-bold mb-4">Popular Pickup Locations in Grey Lynn</h3>
      ...
      <section className="py-16 bg-black text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold mb-4">Ready to Book Your Grey Lynn Airport Transfer?</h2>
