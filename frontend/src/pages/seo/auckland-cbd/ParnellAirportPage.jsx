...
const ParnellAirportPage = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
      <SEO
        title="Parnell to Auckland Airport Shuttle | Private Transfer | BookaRide"
        description="Book your Parnell to Auckland Airport private transfer. Door-to-door service from Parnell Road, Auckland Domain, Parnell Village. Get instant quote!"
        keywords="Parnell airport transfer, Parnell to Auckland Airport, Parnell shuttle, Parnell Road airport taxi, Auckland Domain airport transfer"
        canonical="/parnell-to-airport"
      />
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6">
              Parnell to <span className="text-gold">Auckland Airport</span>
            </h1>
            
            <p className="text-xl text-gray-300 mb-4">
              Private transfers from Auckland's oldest suburb
            </p>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold mb-8 text-center">Parnell Airport Transfer Service</h2>
            <div className="prose prose-lg max-w-none">
              <p>
                Parnell, Auckland's oldest suburb, combines heritage charm with modern sophistication. Whether 
                you're visiting the famous Parnell Rose Gardens, exploring the boutique shops on Parnell Road, 
                or staying near the Auckland Domain, BookaRide provides seamless airport transfers.
              </p>
              <p>
                Our professional drivers know every corner of Parnell and will ensure you reach Auckland Airport 
                comfortably and on time. With real-time flight tracking, we adjust to any delays so you never 
                have to worry about your pickup.
              </p>
            </div>

            <div className="mt-12">
              <h3 className="text-xl font-bold mb-4">Popular Pickup Locations in Parnell</h3>
      ...
      <section className="py-16 bg-black text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold mb-4">Ready to Book Your Parnell Airport Transfer?</h2>
