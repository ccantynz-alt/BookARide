...
export const aucklandSuburbs = [
  ...
  // South Auckland - NEW
  {
    ...
    keywords: 'Manukau airport shuttle, Manukau to Auckland Airport, South Auckland airport transfer',
    attractions: ['Westfield Manukau', 'Rainbow\'s End', 'Vodafone Events Centre'],
    population: '~85,000'
  },
  {
    slug: 'papakura',
    ...
    keywords: 'Papakura airport shuttle, Papakura to Auckland Airport, South Auckland shuttle',
    attractions: ['Papakura Train Station', 'Hawkins Theatre', 'Red Hill Reserve'],
    population: '~50,000'
  },
  {
    slug: 'botany',
    ...
    keywords: 'Botany airport shuttle, Botany to Auckland Airport, East Auckland shuttle',
    attractions: ['Botany Town Centre', 'Ormiston Town Centre', 'Barry Curtis Park'],
    population: '~60,000'
  },
  {
    slug: 'howick',
    ...
    keywords: 'Howick airport shuttle, Howick to Auckland Airport, East Auckland transfer',
    attractions: ['Howick Historical Village', 'Stockade Hill', 'Howick Beach'],
    population: '~40,000'
  },
  {
    slug: 'pakuranga',
    ...
    keywords: 'Pakuranga airport shuttle, Pakuranga to Auckland Airport, East Auckland shuttle',
    attractions: ['Pakuranga Plaza', 'Lloyd Elsmore Park', 'Highland Park'],
    population: '~25,000'
  },
  ...
  // West Auckland - NEW
  {
    ...
    keywords: 'Henderson airport shuttle, Henderson to Auckland Airport, West Auckland transfer',
    attractions: ['Westfield WestCity', 'Henderson Train Station', 'Waitakere Ranges'],
    population: '~70,000'
  },
  {
    slug: 'new-lynn',
    ...
    keywords: 'New Lynn airport shuttle, New Lynn to Auckland Airport, West Auckland shuttle',
    attractions: ['LynnMall', 'New Lynn Train Station', 'Merchant Quarter'],
    population: '~30,000'
  },
  ...
  // Central Auckland - NEW
  {
    ...
    keywords: 'Mt Eden airport shuttle, Mt Eden to Auckland Airport, Central Auckland transfer',
    attractions: ['Mt Eden Summit', 'Eden Park', 'Mt Eden Village'],
    population: '~15,000'
  },
  {
    slug: 'ponsonby',
    ...
    keywords: 'Ponsonby airport shuttle, Ponsonby to Auckland Airport, Central Auckland shuttle',
    attractions: ['Ponsonby Road', 'Western Park', 'Three Lamps'],
    population: '~10,000'
  },
  {
    slug: 'remuera',
    ...
    keywords: 'Remuera airport shuttle, Remuera to Auckland Airport, Central Auckland transfer',
    attractions: ['Remuera Village', 'Orakei Basin', 'Cornwall Park'],
    population: '~20,000'
  }
];
