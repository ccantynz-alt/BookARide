"""
Local Stripe checkout implementation using the official stripe library.
Used by server.py for payment links and webhooks. No Emergent dependency.
"""
            ...
            line_items=[
                {
                    "price_data": {
                        ...
                        "product_data": {"name": req.description or "BookARide booking"},
